        ...
        <div className="mx-auto grid w-[calc(100%-2rem)] max-w-7xl gap-16 lg:w-[calc(100%-3rem)] lg:grid-cols-[0.8fr_1.2fr]">
          <AnimatedSection>
            <div className="sticky top-28">
              ...
              style={{ backgroundImage: 'url("/images/location/location.jpg")', backgroundSize: "cover", backgroundPosition: "center" }}>
                <div className="bg-white/40 p-8 backdrop-blur-sm sm:p-12 rounded-2xl">
                  ...
                  <p className="mt-6 text-xs font-bold uppercase tracking-[0.18em] text-paper">
                    Diani · South Coast
                  </p>
                </div>
              </div>
